<x-layout :title="$title">
    <x-app-shell title="Employee Completion Dashboarsddsd"
        ...
        <section class="minimal-card mb-5 overflow-visible">
            ...
            <x-dashboard.company-filter :companies="$companies" :business-units="$businessUnits" :departments="$departments" :pics="$pics"
                :sources="$sources" :selected-companies="$selectedCompanies" :selected-business-units="$selectedBusinessUnits" :selected-departments="$selectedDepartments" :selected-pics="$selectedPics"
