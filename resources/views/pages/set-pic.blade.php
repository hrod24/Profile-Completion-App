<x-layout :title="$title">
    <div
        id="set-pic-page"
        data-endpoint="{{ route('set-pic.index') }}"
    >
        <x-app-shell
        ...
        >
            ...
            @if ($errors->any())
                <div
                    class="mb-5 rounded-xl border border-rose-200
                        ...
                        <div class="relative">
                            ...
                            >
                                ...
                                >
                                    <path
                                        fill-rule="evenodd"
                                        d="M9 3a6 6 0 104.472 10.003l3.262
                                           3.263a1 1 0 001.414-1.414l-3.263-3.262A6
                                           6 0 009 3zM5 9a4 4 0 118 0 4 4 0 01-8 0z"
                                        clip-rule="evenodd"
                                    />
                                </svg>
                            </div>
                            ...
                            <div
                                id="employee-table-loading"
                                class="pointer-events-none absolute inset-y-0
                                       right-0 hidden items-center pr-3.5"
                            >
                                <svg
                                    class="h-4.5 w-4.5 animate-spin text-kanmo-500"
                                    viewBox="0 0 24 24"
                                    fill="none"
                                    aria-hidden="true"
                                >
            ...
            <section class="minimal-card overflow-hidden">
                ...
                <p
                    ...
                    aria-live="polite"
                    aria-atomic="true"
                    id="set-pic-search-status"
                ></p>

                <div
                    id="set-pic-table-container"
                    aria-busy="false"
                >
