@php
    ...
    $navigation = [
        ...
        [
            ...
            'route' => 'progress-report.index',
            'active' => request()->routeIs('progress-report.*'),
            'icon' => 'report',
        ],
        [
            'label' => 'Upload Excel',
        ...
        @foreach ($navigation as $item)
            <a href="{{ route($item['route']) }}" class="app-sidebar__nav-link"
                ...
                @elseif ($item['icon'] === 'report')
                    <svg class="app-sidebar__nav-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="800px"
