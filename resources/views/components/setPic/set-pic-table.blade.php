...
<div class="overflow-x-auto">
    <table class="w-full min-w-[850px] table-auto text-left">
        <thead class="border-b border-stone-200 bg-stone-50/90">
            <tr>
                <th
                    class="w-16 px-4 py-2.5 text-center
                ...
                <th
                    class="w-14 px-4 py-2.5 text-center
                           text-xs font-bold text-slate-500"
                >
                    <input
                        type="checkbox"
